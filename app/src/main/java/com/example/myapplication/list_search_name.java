...
//This list will be for searching by name

public class list_search_name extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int a=0; a<p; a++)
        {
            names[a] = aulaInfoList.get(a).getName();
        }

        listView = findViewById(R.id.listView);

        aula = new ArrayAdapter<String>(getApplicationContext(), R.layout.list_by_name, R.id.list_name_text, names);
