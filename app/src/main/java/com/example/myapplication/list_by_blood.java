...
public class list_by_blood extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_by_blood);
        ...
        for(int a=0; a<p; a++)
        {
            blood[a] = aulaInfoList.get(a).getBloodGroup()+", "+aulaInfoList.get(a).getName();
        }

        listView = findViewById(R.id.listView_blood);

        aula = new ArrayAdapter<String>(getApplicationContext(), R.layout.list_by_name, R.id.list_name_text, blood);
