...
public class list_search_by_dept extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_search_by_dept);
        ...
        for(int a=0; a<p; a++)
        {
            dept[a] = aulaInfoList.get(a).getDepartment()+", "+aulaInfoList.get(a).getName();
        }

        listView = findViewById(R.id.listView_dept);

        aula = new ArrayAdapter<String>(getApplicationContext(), R.layout.list_by_name, R.id.list_name_text, dept);
